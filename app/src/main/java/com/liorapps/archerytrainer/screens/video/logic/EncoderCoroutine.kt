    ...
    suspend fun run() = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val format = MediaFormat.createVideoFormat(
                ...
                setInteger(MediaFormat.KEY_BIT_RATE, ArcheryTrainerDefaults.BIT_RATE)
                setInteger(MediaFormat.KEY_FRAME_RATE, ArcheryTrainerDefaults.FRAME_RATE)
                setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, ArcheryTrainerDefaults.I_FRAME_INTERVAL)
                setInteger(
